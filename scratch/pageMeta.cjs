...
var pageMeta_exports = {};
__export(pageMeta_exports, {
  ALL_PATHS: () => ALL_PATHS,
  buildMetadata: () => buildMetadata,
  getCrumb: () => getCrumb,
  getPageMeta: () => getPageMeta,
  getSitemapEntries: () => getSitemapEntries,
  getTrail: () => getTrail
});
module.exports = __toCommonJS(pageMeta_exports);

// src/data/site.js
var BUSINESS_NAME = "Sama Alras Technical Services";
var SITE_URL = "https://samalras.com";
var LICENSE_NO = "923026";
var wa = (text) => `https://wa.me/971523606843?text=${encodeURIComponent(text)}`;
var WA_HREF = wa("Hi! I would like a free quote in Dubai.");
var FACEBOOK_URL = "https://www.facebook.com/samaalrastechnical/";
var INSTAGRAM_URL = "https://www.instagram.com/samaalras/";
var GBP_URL = "https://share.google/v2XOAaBq1nnG4rdmv";
var GEO = { latitude: 25.186342, longitude: 55.260148 };
var AREAS = [
  "Dubai Marina",
  "Downtown Dubai",
  "Business Bay",
...
var PAINTING = {
  ...
  card: {
    ...
    description: "Professional painters in Dubai for villas, apartments, offices and building exteriors, plus move-out repaints and waterproofing. Full surface preparation, premium paints and a written warranty on every job.",
  ...
  meta: {
    ...
    description: "Painting services in Dubai for villas, apartments, offices and building exteriors, plus move-out repaints and waterproofing. Experienced painters using Jotun, National Paints and Caparol, with full surface preparation, free colour consultation and a warranty of up to 5 years. Call or WhatsApp now.",
    keywords: "painting services in dubai, painters in dubai, painters near me, painting company near me, best painters dubai, professional painters dubai, villa painting dubai, villa painters dubai, apartment painting dubai, flat painting dubai, house painting dubai, office painting dubai, commercial painting dubai, exterior painting dubai, wall painting dubai, move out painting dubai, painting services dubai marina, painters business bay, villa painting arabian ranches, painters jvc, painting services jumeirah"
  },
  hero: {
    h1Pre: "Painting Services",
    h1Highlight: "in Dubai",
    subtitle: "Professional & Experienced Painters in Dubai Near You",
    intro: "Professional painting services in Dubai for villas, apartments, offices and building exteriors. On time, on budget, and backed by a written 5-year warranty.",
  ...
  services: {
    ...
    intro: "One expert team for every painting job in Dubai. Every project includes free colour consultation, full surface preparation and a written warranty.",
    items: [
      {
        id: "villa-painting",
        image: "/images/services/villa-painting.webp",
        ...
        description: "Complete villa painting in Dubai: interiors, exteriors, boundary walls, pergolas and gates. Our villa painters handle everything from Arabian Ranches family homes to Palm Jumeirah waterfront villas with full surface preparation, premium Jotun and Caparol paints, and dust-free workmanship.",
      ...
      },
      {
        ...
        description: "Fast, affordable apartment painting in Dubai with fixed transparent pricing. From studio apartments in JVC to penthouses in Dubai Marina, our apartment painters finish most flats in 1-2 days: furniture covered, floors protected, and a spotless clean-up before handover.",
      ...
      },
      {
        ...
        description: "Professional office painting in Dubai delivered after hours, overnight or on weekends so your business never stops. We paint offices, retail stores, restaurants, clinics, gyms and warehouses across Business Bay, DIFC, Deira and every free zone, fully insured and DM-compliant.",
      ...
      },
      {
        ...
        description: "Exterior wall and facade painting in Dubai engineered for 45\xB0C summers, humidity and sand abrasion. Our exterior painting contractors use UV-resistant, weatherproof paint systems with proper crack filling and priming, so buildings, villas and compounds stay vibrant for years.",
      ...
      },
      {
        ...
        description: "Moving out of a rental in Dubai? Our move-out painting service restores apartments and villas to landlord-approved handover condition, often the same day you call. Tenants use us to secure their full security deposit; landlords use us to get units market-ready fast.",
      ...
      },
      {
        ...
        description: "Cracks, damp patches and peeling paint always come back unless the root cause is fixed. Our waterproofing and painting contractors in Dubai repair wall cracks, damp-proof ceilings, waterproof roofs and bathrooms, then repaint with a finish that lasts, backed by warranty.",
  ...
  whyUs: {
    ...
    intro: "Anyone can hold a roller. Delivering a flawless, long-lasting finish in Dubai's climate, on schedule and on budget, takes a professional system.",
    reasons: [
...
var SPC = {
  ...
  card: {
    ...
    description: "Supply and installation of 100% waterproof, scratch-resistant SPC flooring in Dubai, plus vinyl, laminate, wooden, parquet and epoxy floors. Free on-site measurement, fast fitting and clean handover.",
  ...
  meta: {
    ...
    description: "SPC flooring in Dubai supplied and installed by Sama Alras: 100% waterproof, scratch-resistant floors for villas, apartments and offices, plus vinyl and LVT, laminate, wooden and epoxy. Free measurement, fitting over existing tiles and fast installation across Dubai. Call or WhatsApp now.",
    keywords: "spc flooring, spc floor, spc flooring dubai, spc flooring in dubai, spc flooring near me, flooring company near me, flooring spc, waterproof spc flooring, spc vinyl flooring dubai, vinyl flooring dubai, lvt flooring dubai, laminate flooring dubai, wooden flooring dubai, parquet flooring dubai, epoxy flooring dubai, carpet flooring dubai, flooring installation dubai, flooring contractors dubai, spc flooring dubai marina, flooring jvc, flooring business bay, flooring arabian ranches"
  },
  hero: {
    h1Pre: "SPC Flooring in",
    h1Highlight: "Dubai",
    subtitle: "Waterproof, Scratch-Resistant SPC Floors Fitted Across Dubai",
    intro: "A modern SPC floor gives you the look of real wood or stone with a rigid, 100% waterproof core built for Dubai homes and offices. Free measurement, expert fitting and a clean handover, with SPC flooring near you anywhere in the city.",
  ...
  services: {
    ...
    intro: "From rigid-core SPC flooring to vinyl, laminate, wooden and epoxy floors, our flooring SPC specialists supply and fit the right surface for every room. Every job includes free measurement, subfloor checks and a tidy, dust-controlled installation.",
    items: [
      {
        id: "spc-flooring",
        ...
        description: "SPC flooring (stone-plastic composite) is the toughest floating floor for Dubai: a rigid, 100% waterproof core with a realistic wood or stone top layer. We supply and install SPC flooring in villas, apartments and offices with a fast click-lock fit, so an SPC floor is ready to walk on the same day. Ask for SPC flooring near you and we measure for free.",
      ...
      },
      {
        ...
        description: "Luxury vinyl tile (LVT) and vinyl flooring give a warm, quiet, water-resistant floor that suits bedrooms, retail and clinics. We fit glue-down and click vinyl over a properly prepared subfloor for a smooth, long-lasting finish across Dubai.",
      ...
      },
      {
        ...
        description: "Engineered wood and parquet flooring bring natural warmth to villas and premium apartments. We supply, fit and finish wooden floors with the right underlay and expansion gaps so they stay stable in Dubai\u2019s humidity, with sanding and refinishing available too.",
      ...
      },
      {
        ...
        description: "Laminate flooring is a fast, affordable way to get a wood-look floor with a tough scratch-resistant surface. Ideal for bedrooms, living rooms and offices, our laminate floors click together over a foam underlay for a quick, clean installation anywhere in Dubai.",
      ...
      },
      {
        ...
        description: "Epoxy resin flooring creates a seamless, hard-wearing, easy-clean surface for garages, warehouses, kitchens, gyms and car parks. We prepare the concrete, fill cracks and apply a durable epoxy coating that resists chemicals, oil and heavy traffic across Dubai.",
      ...
      },
      {
        ...
        description: "Soft broadloom carpet and modular carpet tiles for bedrooms, majlis rooms, offices and meeting spaces. We supply and fit acoustic-friendly carpet that reduces noise and adds comfort, with hard-wearing commercial ranges for busy Dubai workplaces.",
  ...
  whyUs: {
    ...
    intro: "A great floor is 90% preparation. We measure accurately, check your subfloor and fit every plank properly, so your SPC flooring looks perfect and lasts for years.",
    reasons: [
...
var ELECTRICIAN = {
  ...
  card: {
    ...
    description: "Licensed electricians in Dubai for wiring and rewiring, light and chandelier installation, DB board repairs, switches and sockets, ceiling fans and 24/7 emergency fault finding. Safe, tidy and fully insured.",
  ...
  services: {
    ...
    intro: "One licensed team for every electrical job in Dubai, from small repairs to full installations. Every visit is carried out safely, tested and left clean and tidy.",
    items: [
      {
        id: "wiring-rewiring",
        ...
        description: "New wiring for renovations and full rewiring for older villas and apartments in Dubai. We install and upgrade circuits, run new cabling for kitchens, ACs and extensions, and make sure everything is earthed, tested and compliant with DEWA standards.",
      ...
      },
      {
        ...
        description: "Supply and installation of all lighting: LED downlights, spotlights, ceiling lights, wall lights and heavy chandeliers. We mount fixtures securely, replace old fittings with energy-saving LEDs and set up dimmers and smart lighting across Dubai homes and offices.",
      ...
      },
      {
        ...
        description: "If your power keeps tripping or a breaker will not reset, our electricians diagnose and repair distribution boards (DB boards) and fuse boxes fast. We replace faulty MCBs and RCDs, upgrade overloaded boards and label every circuit for safety.",
      ...
      },
      {
        ...
        description: "Adding, moving or replacing switches, sockets and power points in Dubai. We install USB sockets, extra power points for appliances and home offices, replace burnt or loose fittings and fix outlets that have stopped working, all neatly and safely.",
      ...
      },
      {
        ...
        description: "Supply, installation and repair of ceiling and exhaust fans in Dubai. We mount new fans securely, replace old or noisy units, fix wobble and speed-control faults, and install bathroom and kitchen exhaust fans for proper ventilation.",
      ...
      },
      {
        ...
        description: "Power failure, burning smell, sparking socket or total blackout? Our 24/7 emergency electricians in Dubai respond fast, trace the fault safely and get your power back on. We handle short circuits, tripping, and sudden outages any time of day or night.",
  ...
  whyUs: {
    ...
    intro: "Electrical work is not the place to cut corners. Our licensed electricians work safely, test everything and leave your home or office exactly as they found it, only safer.",
    reasons: [
...
var AC_DUCT = {
  ...
  card: {
    ...
    description: "Professional AC duct cleaning in Dubai for villas, apartments and offices: full duct, coil, AC vent and filter cleaning plus anti-bacterial sanitising. Cleaner air, better cooling and a written guarantee on every job.",
  ...
  meta: {
    ...
    description: "Professional AC duct cleaning in Dubai for villas, apartments and offices. Sama Alras cleans ducts, coils, AC vents and filters, then sanitises the system for cleaner air and better cooling. Searching for AC duct cleaning near me? Free quotes and same-day service. Call or WhatsApp now.",
    keywords: "ac duct cleaning, ac duct cleaning in dubai, ac duct cleaning dubai, air conditioning duct cleaning, ac duct cleaning near me, ac vent cleaning, ac air duct cleaning, ac and duct cleaning, ac vent duct cleaning, aircon duct cleaning, ac duct cleaning service, air vent cleaning near me, ac duct cleaning company in dubai, duct cleaning dubai, air duct cleaning dubai, duct cleaning in dubai, ac cleaning service dubai, ac duct cleaning services dubai, ac duct cleaning service dubai, best ac duct cleaning dubai, ac duct cleaning service in dubai, ac coil cleaning dubai, ac duct sanitisation dubai, ac filter replacement dubai, commercial duct cleaning dubai, ac duct cleaning dubai marina, ac duct cleaning jvc, ac duct cleaning business bay, ac duct cleaning arabian ranches"
  },
  hero: {
    h1Pre: "AC Duct Cleaning in",
    h1Highlight: "Dubai",
    subtitle: "Professional Air Conditioning Duct Cleaning in Dubai Near You",
    intro: "Complete AC duct cleaning in Dubai for villas, apartments and offices. We clean ducts, coils, AC vents and filters, then sanitise the whole system for cleaner air, fresher rooms and better cooling. Searching for AC duct cleaning near me? Same-day teams cover every community in the city.",
  ...
  services: {
    ...
    intro: "One expert team for every part of your air conditioning system. Our AC duct cleaning services in Dubai combine powerful extraction, coil and AC vent cleaning and anti-bacterial sanitising, with free inspection and a written guarantee on every job.",
    items: [
      {
        id: "ac-duct-cleaning",
        ...
        description: "Complete air conditioning duct cleaning for homes in Dubai. We open your supply and return ducts, brush and vacuum out years of dust, sand and debris with sealed extraction equipment, and leave the airflow strong and the air clean. The core AC duct cleaning service for villas, apartments and townhouses.",
      ...
      },
      {
        ...
        description: "Dirty evaporator and condenser coils are the number one reason an AC stops cooling in Dubai. We deep-clean the coils with safe foam cleaners, clear the drain line and tray, and restore proper heat transfer, so your unit cools faster and uses less electricity.",
      ...
      },
      {
        ...
        description: "Black marks and dust around your AC vents mean it is time for AC vent cleaning. We remove, wash and refit every grille, diffuser and register, then clean the vent duct behind it. If you are searching for air vent cleaning near me, this is the fast, visible refresh that makes rooms feel cleaner instantly.",
      ...
      },
      {
        ...
        description: "Cleaning removes the dust, sanitising removes what you cannot see. After the AC and duct cleaning we fog the system with a safe, hospital-grade anti-bacterial and anti-mould treatment that kills germs, clears musty smells and keeps the air healthy for your family, pets and staff.",
      ...
      },
      {
        ...
        description: "Pair your duct cleaning with a full AC cleaning service in Dubai. We wash or replace clogged filters, check gas pressure, test the thermostat and tighten connections, so your air conditioning runs efficiently through the summer. Ideal as a regular aircon duct cleaning and maintenance visit.",
      ...
      },
      {
        ...
        description: "A trusted AC duct cleaning company in Dubai for businesses. We clean large HVAC ductwork and AHUs in offices, shops, restaurants, clinics and warehouses, working after hours or on weekends so you stay open. Scheduled duct cleaning that keeps staff healthy and meets building management standards.",
  ...
  whyUs: {
    ...
    intro: "Anyone can wipe a vent. Actually cleaning and sanitising a full duct system in Dubai\u2019s dust and humidity, safely and thoroughly, takes proper equipment and trained technicians.",
    reasons: [
...
var CLEANING = {
  ...
  card: {
    ...
    description: "Professional cleaning services in Dubai for homes, offices and commercial spaces, including residential cleaning, deep cleaning, move-in and move-out cleaning, and after-painting or renovation dust removal.",
  ...
  meta: {
    ...
    description: "Cleaning services in Dubai for villas, apartments, offices and commercial spaces. Sama Alras provides deep cleaning, move-in/out cleaning, sanitising, after-painting dust removal and same-day quotes across Dubai. Call or WhatsApp now.",
    keywords: "cleaning services in dubai, cleaning company dubai, villa cleaning dubai, apartment cleaning dubai, office cleaning dubai, deep cleaning dubai, move out cleaning dubai, move in cleaning dubai, after painting cleaning dubai, cleaning services near me, cleaners in dubai, house cleaning dubai, commercial cleaning dubai, office cleaning dubai marina, cleaners jvc, cleaning services business bay, cleaning services Arabian Ranches"
  },
  hero: {
    h1Pre: "Cleaning Services in",
    h1Highlight: "Dubai",
    subtitle: "Professional Cleaning for Homes, Offices and Commercial Spaces",
    intro: "Trusted cleaning services in Dubai for homes, offices and commercial properties. From deep cleaning to move-in and move-out cleaning, we leave spaces fresh, tidy and presentation-ready.",
  ...
  services: {
    ...
    intro: "A full cleaning service for homes and businesses. We bring the equipment, follow a consistent checklist and finish by quality-checking every room before we leave.",
    items: [
      {
        id: "villa-cleaning",
        ...
        description: "Regular and deep villa cleaning in Dubai for family homes, townhouses and luxury villas. We clean bedrooms, living areas, kitchens, bathrooms, windowsills and common surfaces with a room-by-room checklist and final inspection.",
      ...
      },
      {
        ...
        description: "Apartment cleaning in Dubai for residents, landlords and tenants. We clean the full property including living rooms, bedrooms, kitchens, bathrooms and balconies, with careful attention to high-touch areas and finishing details.",
      ...
      },
      {
        ...
        description: "Office cleaning in Dubai for commercial spaces, clinics and retail premises, with dusting, mopping, sanitising, reception cleaning and washroom maintenance. We can schedule work before opening hours or after closing to keep operations running smoothly.",
      ...
      },
      {
        ...
        description: "Deep cleaning tackles built-up dust, greasy kitchen areas, bathroom grout, behind appliances and overlooked corners that regular cleaning misses. Ideal for seasonal refreshes, rented properties and after a renovation or repaint.",
      ...
      },
      {
        ...
        description: "Move-in and move-out cleaning is designed for tenants, landlords and property managers who need a vacancy-ready finish. We clean the whole property to a high presentation standard so it is ready for handover, new furnishings or a new family.",
      ...
      },
      {
        ...
        description: "Renovations and paint jobs leave dust in every room. Our after-paint and renovation cleaning service removes fine particles, polishes surfaces and restores the space so it is ready for furniture, move-in or final handover.",
  ...
  whyUs: {
    ...
    intro: "A clean space should feel calm, hygienic and ready to use. We combine practical cleaning checks, modern equipment and a strict finish standard to deliver that result every time.",
    reasons: [
...
var CARPENTER = {
  ...
  card: {
    ...
    description: "Professional carpenter services in Dubai for custom kitchens, built-in wardrobes, door installation, villa joinery, office woodwork and furniture repair. Free on-site measurement, precision fitting and a written warranty on every job.",
  ...
  meta: {
    ...
    description: "Professional carpenter services in Dubai for custom kitchens, built-in wardrobes, door installation, villa joinery, office partitions and furniture repair. Experienced carpenters with free on-site measurement and a written warranty. Call or WhatsApp now.",
    keywords: "carpenter dubai, carpenter in dubai, carpenter near me, carpentry services dubai, carpenter services dubai, kitchen carpenter dubai, kitchen cabinets dubai, wardrobe carpenter dubai, built in wardrobe dubai, door installation dubai, door repair dubai, joinery dubai, custom joinery dubai, office carpenter dubai, furniture repair dubai, carpenter dubai marina, carpenter jvc, carpenter arabian ranches, carpenter business bay, wood work dubai, carpentry company dubai, best carpenter dubai"
  },
  hero: {
    h1Pre: "Carpenter Services in",
    h1Highlight: "Dubai",
    subtitle: "Expert Carpenters for Kitchens, Wardrobes, Doors & Custom Joinery",
    intro: "Professional carpentry services in Dubai for custom kitchens, built-in wardrobes, door installation, villa joinery, office woodwork and furniture repair. Free on-site measurement, precision craftsmanship and a written warranty on every job.",
    image: "/images/services/carpenter/carpenter_services_dubai.webp",
  ...
  services: {
    ...
    intro: "From a single door repair to a full villa joinery package, our carpenters deliver precision woodwork built for Dubai homes and businesses. Every job includes free measurement, quality materials and a clean, professional handover.",
    items: [
      {
  ...
  whyUs: {
    ...
    intro: "Good carpentry is invisible: doors close silently, drawers glide, cabinets stay square and shelves hold weight without sagging. That takes experience, proper materials and honest measurement.",
    reasons: [
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Do your carpenters work in offices and commercial spaces?", a: "Yes. We build and install reception desks, workstation partitions, filing and storage walls, boardroom tables, display units, retail shelving and caf\xE9 counters. Commercial carpentry is scheduled after hours, overnight or on weekends so your business continues without interruption. Materials are commercial-grade with scratch-resistant laminate, metal edge banding and concealed cable management as standard." },
...
var PLUMBING = {
  ...
  card: {
    ...
    description: "Licensed plumbers in Dubai for emergency leaks, blocked drains, kitchen sink problems, water heater repair and full bathroom installation. Same-day service, fixed written pricing and 24/7 emergency cover.",
  ...
  meta: {
    ...
    description: "Plumbing service in Dubai for leaks, blocked drains, kitchen sinks and water heater repair. Licensed plumbers, same-day slots and 24/7 emergency plumber cover across Dubai. Free fixed quotes. Call or WhatsApp now.",
    keywords: "plumber, plumbers near me, plumbers close to me, near me plumber, plumbing services, emergency plumber, emergency plumber near me, plumbing services near me, water heater repair near me, kitchen sink drain, plumber in dubai, plumbing services dubai, emergency plumber dubai, water heater repair dubai, water heater repair in dubai, plumbing company dubai"
  },
  hero: {
    h1Pre: "Plumbing Service in Dubai",
    h1Highlight: "\u2013 Fast Same-Day Service",
    subtitle: "Get fast, reliable plumbing solutions for leaks, blocked drains, water heaters, kitchen sinks and emergency plumbing problems across Dubai.",
    intro: "Licensed plumbers in Dubai, available seven days a week with 24/7 emergency cover. Searching for plumbers near me? We arrive with the parts, diagnose properly and quote a fixed price before we start.",
  ...
  services: {
    ...
    intro: "One licensed team for every plumbing job in Dubai, from a dripping tap to a flooded bathroom at 2am. Every call-out includes a proper diagnosis, a fixed written price before work starts and a workmanship warranty.",
    items: [
      {
        ...
        description: "Burst pipe, overflowing toilet or water coming through a ceiling? Our emergency plumber teams answer 24 hours a day, seven days a week, and are dispatched to the nearest available plumber rather than queued behind scheduled jobs. If you are searching for an emergency plumber near me at midnight, we will talk you through isolating the water on the phone while we are on the way.",
      ...
      },
      {
        ...
        description: "Slow-draining showers, gurgling toilets and bad smells are all the same story: a partial blockage that will become a full one. We clear blocked drains and sewer lines with drain machines and high-pressure jetting, then camera the line so you know whether it was grease, hair, wipes or a broken pipe causing it.",
      ...
      },
      {
        ...
        description: "The kitchen sink drain is the hardest-working waste pipe in any home and the first to block with grease and food waste. We clear the blockage, replace failed traps and waste pipes, stop the leak in the cupboard underneath, and fit or reconnect sinks, mixers and waste disposal units.",
      ...
      },
      {
        ...
        description: "No hot water, lukewarm water or a heater leaking into the ceiling void are the three calls we get most. Our water heater repair service in Dubai covers thermostats, heating elements, tripping breakers, pressure valves and tank leaks, and where a unit is beyond economical repair we supply and install a replacement the same day.",
      ...
      },
      {
        ...
        description: "Running toilets, dripping mixers and tired bathrooms. We repair or replace toilets, cisterns, flush valves, taps, mixers, showers, bidet sprays and basins, and handle complete bathroom plumbing for renovations, working alongside our own tiling, painting and electrical teams on a single schedule.",
  ...
  whyUs: {
    ...
    intro: "Anyone can tighten a fitting. Diagnosing a concealed leak correctly, clearing a drain so it stays clear, and doing it without wrecking your finishes is what separates a plumbing company from a handyman with a wrench.",
    reasons: [
...
var SERVICES_LIST = [PAINTING, SPC, ELECTRICIAN, AC_DUCT, PLUMBING, CLEANING, CARPENTER];
var SERVICES_BY_PATH = Object.fromEntries(SERVICES_LIST.map((s) => [s.path, s]));
...
var HOME = {
  ...
  hub: {
    ...
    intro: "Seven specialist teams under one trusted name. Choose a service to see full details, or call us and we will point you to the right crew."
  },
  overview: {
    heading: "Your One-Stop Technical Services Company in Dubai",
    paragraphs: [
      "Sama Alras Technical Services is a licensed Dubai company that has looked after homes and businesses across the city since 2013. Instead of juggling separate contractors, you get seven specialist teams under one roof: professional painting, licensed plumbing, SPC and other flooring, licensed electrical work, AC duct cleaning, detailed cleaning services and carpentry services.",
      "Our painting team delivers spotless interiors, durable exteriors and clean, on-time handovers. Our plumbers handle emergency leaks, blocked drains, kitchen sink problems, water heater repair and full bathroom installation, with 24/7 cover. Our flooring team supplies and fits waterproof SPC flooring along with vinyl, laminate, wooden, epoxy and carpet floors. Our licensed electricians handle wiring, lighting, DB boards, sockets, fans and 24/7 emergency call-outs. Our AC duct cleaning team clears and sanitises your air conditioning ducts, coils and vents for cleaner air and better cooling. Our cleaning team manages deep cleaning, move-in and move-out cleaning, office cleaning and property presentation. Our carpenter team handles custom kitchens, built-in wardrobes, door installation, villa joinery, office woodwork and furniture repair.",
    ...
    links: [
      ...
      { label: "Electrician Services", to: "/services/electrician-services" },
      { label: "AC Duct Cleaning", to: "/services/ac-duct-cleaning-services" },
      { label: "Cleaning Services", to: "/services/cleaning-services-dubai" },
      { label: "Carpenter Services", to: "/services/carpenter-services-dubai" }
    ]
  },
  whyUs: {
    heading: "Why Dubai Trusts Sama Alras Technical Services",
    intro: "Whether you need a wall painted, a leak traced, a floor fitted, a duct cleaned or a fault fixed, you get the same standard: skilled, insured tradesmen, honest pricing and work that is done properly the first time.",
    reasons: [
  ...
  process: {
    ...
    steps: [
      { step: "1", title: "Tell us what you need", text: "Call or WhatsApp us with your painting, plumbing, flooring, AC duct cleaning, cleaning or carpentry project. We arrange a free site visit, often the same day." },
...
// src/data/pageMeta.js
var OG_IMAGE = `${SITE_URL}/og-cover.jpg`;
var TELEPHONE = "+971523606843";
var ADDRESS = {
  "@type": "PostalAddress",
...
var LICENSE_IDENTIFIER = {
  "@type": "PropertyValue",
  name: "License Number",
  value: LICENSE_NO
};
var SAME_AS = [GBP_URL, FACEBOOK_URL, INSTAGRAM_URL];
...
var businessLd = {
  ...
  description: "Sama Alras Technical Services is a licensed Dubai company providing professional painting, licensed plumbing, SPC and other flooring, AC duct cleaning, cleaning services, carpentry services, and licensed electrical work across every community in Dubai.",
  url: `${SITE_URL}/`,
  telephone: TELEPHONE,
  image: OG_IMAGE,
  address: ADDRESS,
...
function servicesCollectionLd(path) {
  ...
  return {
    ...
    "@id": `${url}#collection`,
    name: "Technical Services in Dubai",
    description: "Every service provided by Sama Alras Technical Services in Dubai: painting, plumbing, SPC and other flooring, licensed electrical work, AC duct cleaning, cleaning services and carpentry services.",
    isPartOf: { "@id": `${url}#webpage` },
    about: { "@id": `${SITE_URL}/#business` },
    inLanguage: "en",
    mainEntity: {
...
var PAGES = {
  "/": {
    ...
    description: "Painting Services, Plumbing Services, SPC Flooring, Electrician Services, AC Duct Cleaning, Cleaning Services and Carpenter Services in Dubai.",
    keywords: "technical services dubai, painting services dubai, house painting dubai, villa painting dubai, apartment painting dubai, plumbing services dubai, plumber in dubai, emergency plumber dubai, water heater repair dubai, spc flooring dubai, vinyl flooring dubai, laminate flooring dubai, ac duct cleaning dubai, ac duct cleaning services dubai, duct sanitisation dubai, electrician dubai, emergency electrician dubai, electrical wiring dubai, cleaning services dubai, office cleaning dubai, villa cleaning dubai, carpenter services dubai, carpenter in dubai, home maintenance dubai",
    crumb: "Home",
    priority: 1,
  ...
  "/services": {
    ...
    description: "Browse all seven technical services from Sama Alras: painting, plumbing, SPC flooring, licensed electrical work, AC duct cleaning, cleaning services and carpentry services across every community in Dubai. Free site visit, fixed written quote and a workmanship warranty on every job.",
    keywords: "technical services dubai, home maintenance services dubai, home maintenance company dubai, technical services company dubai, property maintenance dubai, painting services dubai, plumbing services dubai, spc flooring dubai, electrician dubai, ac duct cleaning dubai, cleaning services dubai, carpenter services dubai, all home services dubai",
    crumb: "Services",
    priority: 0.9,
    changeFrequency: "weekly"
  },
  "/about": {
    ...
    description: "Sama Alras Technical Services is a trusted Dubai company for painting, plumbing, flooring, AC duct cleaning and electrical work, serving 4,800+ homes and businesses since 2013. Meet the five specialist teams behind the work.",
    keywords: "about sama alras, technical services company dubai, painting flooring electrical dubai, plumbing company dubai, ac duct cleaning company dubai, licensed technical services team dubai",
    crumb: "About",
    priority: 0.7,
  ...
  "/contact": {
    ...
    description: "Contact Sama Alras Technical Services for a free quote on painting, flooring, AC duct cleaning or electrical work in Dubai. Call +97152360 6843, WhatsApp or send the quick form, 7 days a week.",
    keywords: "contact sama alras, free quote dubai, painter flooring electrician dubai contact, ac duct cleaning quote dubai",
    crumb: "Contact",
    priority: 0.8,
    changeFrequency: "monthly"
  },
  "/privacy-policy": {
    ...
    description: "How Sama Alras Technical Services collects, uses and protects your personal information when you request a quote or use our website.",
    keywords: "",
  ...
  "/terms": {
    ...
    description: "The terms and conditions that apply to quotes, bookings, warranties and services provided by Sama Alras Technical Services in Dubai.",
    keywords: "",
...
var ALL_PATHS = Object.keys(PAGES);
...
var FALLBACK_PATH = "/";
var SERVICES_HUB_PATH = "/services";
