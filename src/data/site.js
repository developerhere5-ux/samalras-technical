...
export const PHONE_DISPLAY = '+97152360 6843'
export const PHONE_LINK = 'tel:+971523606843'
...
export const wa = (text) => `https://wa.me/971523606843?text=${encodeURIComponent(text)}`
