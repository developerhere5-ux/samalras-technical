export const HOME = {
  ...
  hub: {
    ...
    intro:
      'Seven specialist teams under one trusted name. Choose a service to see full details, or call us and we will point you to the right crew.',
  },
  overview: {
...
export const SERVICES_HUB = {
  ...
  lead: [
    'Sama Alras Technical Services covers seven trades from one licensed Dubai company: painting, plumbing, SPC and other flooring, licensed electrical work, AC duct cleaning, cleaning services and carpentry services. Each trade has its own permanent crew, employed, trained and insured by us rather than day-hired for the job, which is why the standard of work does not change when the trade does.',
